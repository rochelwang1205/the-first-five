...
import AOSProvider from "../../styles/AOSProvider";
...
export default function AppLayout() {
  ...
  return (
    <AOSProvider>
      <div
        className={`layout d-flex flex-column min-vh-100 ${
      ...
      >
        <Navbar
          ...
          className={`layout__nav ${
            fullBleed
              ? "bg-transparent position-absolute top-0 start-0 end-0 z-3"
              : "bg-body sticky-top"
          }`}
        >
          <Container>
        ...
        <footer
          className={`bg-dark py-4 font-sans fw-regular ${
            fullBleed
        ...
        >
          <Container>
            <p className="text-center mb-0 text-white text-12 text-sm-16">
              ...
              <br />
              This is not investment advice. You are solely responsible for your
