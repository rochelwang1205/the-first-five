export default function FaqPage() {
  ...
  return (
    ...
    <div style={{ backgroundImage: `url(${faqBg})`, backgroundSize: "contain", backgroundPosition: "center top", backgroundRepeat: "repeat" }} >
      <div className="p-1 p-sm-3 mx-sm-5">
        <h1 className="text-center py-4">FAQs</h1>
        <section className="bg-primary text-white p-4 my-3 rounded-4" data-aos="fade-up" data-aos-duration="1000"
     data-aos-easing="ease-in-sine" >
          ...
          <p className="font-sans fw-regular text-16 text-lg-20">This is an online learning simulator that provides various financial application scenarios. Here you may find questions you have never thought about before, regulark in advance and get some directions and suggested resources.</p>
        </section>
        <section className="bg-primary text-white p-4 my-3 rounded-4 " data-aos="fade-up" data-aos-duration="1300"
     data-aos-easing="ease-in-sine">
     ...
     data-aos-easing="ease-in-sine">
          ...
          <p className="font-sans fw-regular text-16 text-lg-20">We hope this platform can help high school and college students who lack knowledge and experience or feel uncertain about their future. Of course, the general public who is interested in financial literacy can also participate in TF5.</p>
        </section>
        <section className="bg-primary text-white p-4 my-3 rounded-4" data-aos="fade-up" data-aos-duration="1000"
     data-aos-easing="ease-in-sine">
     ...
     data-aos-easing="ease-in-sine">
          ...
          <div>
            <p className="font-sans fw-regular text-16 text-lg-20">Engineer｜Rochelle Wang, Developer. Develop for TF5.<br/>
